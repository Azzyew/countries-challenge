...
export function CountryCard({ flagSrc, name, population, region, capital }: CountryCardProps) {
  return (
    <div className="drop-shadow-md overflow-hidden bg-white rounded-md text-base w-64 dark:bg-primary-300 xl:w-80 hover:bg-[#f5f5f5] dark:hover:bg-[#334351]">
      <Image src={flagSrc} width={0} height={0} alt={`${name}'s flag`} sizes="100%" className="w-full h-60" loading='eager'/>
